...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "90fb9e96-47aa-4b0b-8f4f-8d754d1d421b");
  ...
  return (
    ...
    initial={{opacity : 0, x:-200}}
     ...
     className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
      ...
      <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Ready to make a move? Let's build your future.</p>
