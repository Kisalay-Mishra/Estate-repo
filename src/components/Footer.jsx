      ...
      <div className="container flex mx-auto flex-col md:flex-row justify-between items-center">
        <div className="w-full md:w-1/3 mb-8 md:mb-0">
          ...
          <p className="text-gray-500 mt-4">
            ...
            laboriosam eius perspiciatis natus excepturi facere at illo in
            possimus distinctio! Nulla molestiae laborum aliquid repellat velit
            facilis veritatis sequi explicabo?
          </p>
        </div>
